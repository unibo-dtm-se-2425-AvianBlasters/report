...
Mr. Odie in his trused Jolly Runner must fend off the Avians for as long as possible by:
...
![Green Jolly Runner](../../pictures/car_green.png)
...
**Blue**: the Jolly Runner has collected an invunerability Power-Up and it is completely invulnerable to enemy projectiles.

![Blue Jolly Runner](../../pictures/car_invulnerable.png)

**Orange**: the Jolly Runner has collected a Power-Up enhancing its capabilities.

![Orange Jolly Runner](../../pictures/car_power_up.png)
